...
- `generate_slides_design_spec` — 전체/선택적 슬라이드 디자인 스펙 병렬 생성 (ADR-0018).
- `modify_design_spec` — 개별 슬라이드 추가/수정/삭제 (ADR-0014).
...
- [ADR-0011: 점진적 구체화 파이프라인](./0011-progressive-refinement-pipeline.md)
- [ADR-0014: 파일 기반 통신 + 슬라이드 단위 CRUD](./0014-file-based-communication-and-per-slide-crud.md)
- [ADR-0016: 슬라이드별 HTML iframe](./0016-per-slide-html-iframe.md)
- [ADR-0017: 폰트 메트릭 기반 텍스트 오버플로우 방지](./0017-font-metric-text-overflow-prevention.md)
- [ADR-0018: 디자인 스펙 병렬 생성](./0018-parallel-design-spec-and-prompt-caching.md)
- [ADR-0021: 슬라이드 타입별 시스템 프롬프트 분리](./0021-slide-type-specific-system-prompts.md)
