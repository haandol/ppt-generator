...
- [ADR-0018: 디자인 스펙 병렬 생성, 프롬프트 캐싱 및 Adaptive Effort](./0018-parallel-design-spec-and-prompt-caching.md)
- [ADR-0020: 토큰 사용량 추적 및 비용 추정](./0020-token-usage-tracking-and-cost-estimation.md)
