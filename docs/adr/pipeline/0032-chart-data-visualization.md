...
- **Single Source of Truth 유지**: 기존 디자인 스펙 → {HTML, PPTX} 결정적 변환 아키텍처(ADR-0013)를 그대로 따른다.
...
- [ADR-0013: Design Spec Pipeline](0013-design-spec-pipeline.md) — 디자인 스펙 아키텍처
- [ADR-0030: Image Path Support](0030-image-path-and-corner-radius-support.md) — 새 요소 타입 추가 선례
