...
- 레이아웃 (반드시 아래 좌표를 그대로 사용):
  · 대제목: left=64, top=260, width=1152, height=80(1줄) 또는 160(2줄), font_size_pt 40~44, bold, vertical_alignment "middle". 제목이 길어서 2줄이 되면 height=160으로 설정하고, 구분선과 부제목의 top도 함께 아래로 조정하세요.
    ...
    "textboxes": [
      {
        ...
        "paragraphs": [
          {"runs": [{"text": "프레젠테이션 대제목", "font_size_pt": 40, "color": "#FFFFFF", "bold": true, "italic": false}], "bullet_level": -1, "alignment": "left"}
        ]
      },
      {
...
<typography_rules>
- 슬라이드 대제목: font_size_pt 40~44, bold
...
9. 대제목 폰트 크기: 대제목 텍스트의 font_size_pt는 반드시 40~44 범위로 설정하세요. 40pt 미만은 금지합니다.
</constraints>
