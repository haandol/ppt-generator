...
PPTX_FONT_MIN_SIZE_PT = 16
PPTX_FONT_SCALE_FACTOR = 1.5
...
__all__ = [
    ...
    "PPTX_SLIDE_WIDTH_EMU", "PPTX_SLIDE_HEIGHT_EMU", "PPTX_FONT_NAME",
    "PPTX_BODY_FONT_SIZE_PT", "PPTX_TITLE_FONT_SIZE_PT", "REM_TO_PX",
    "PPTX_FONT_MIN_SIZE_PT", "PPTX_FONT_SCALE_FACTOR",
    ...
    "PPTX_CONVERT_MODEL_ID", "PPTX_CONVERT_MAX_TOKENS",
    # JSON schemas
    ...
    "SLIDES_SYSTEM_PROMPT", "SLIDES_USER_PROMPT_TEMPLATE",
    "SLIDES_BATCH_USER_PROMPT_TEMPLATE", "SLIDES_DESIGN_SUMMARY_PROMPT",
    "SLIDES_MODIFY_SYSTEM_PROMPT", "SLIDES_MODIFY_USER_PROMPT_TEMPLATE",
    "SLIDES_MODIFY_SINGLE_USER_PROMPT_TEMPLATE", "SLIDES_MAX_PER_BATCH",
    "PPTX_CONVERT_SYSTEM_PROMPT", "PPTX_CONVERT_USER_PROMPT_TEMPLATE",
    "PPTX_CONVERT_USER_PROMPT_WITH_IMAGE_TEMPLATE",
    # Paths
    "PPT_GENERATOR_HOME",
]
