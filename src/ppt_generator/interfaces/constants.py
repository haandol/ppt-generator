...
SLIDES_SYSTEM_PROMPT = (
    ...
    "  · 태그/라벨: font-family:monospace, font-size:0.875rem(14px)\n"
...
SLIDES_REGION_SYSTEM_PROMPT = (
    ...
    "영역별 콘텐츠 가이드:\n"
    "- title 영역: 제목 텍스트. font-size:2.25rem(36px) 이상, font-weight:800. .divider-bar 등 장식 요소 포함 가능.\n"
    "- subtitle 영역: 부제목/설명 텍스트. font-size:1.25rem(20px) 이상, font-weight:400.\n"
