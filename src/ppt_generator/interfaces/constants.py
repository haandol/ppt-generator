...
SLIDES_SYSTEM_PROMPT = (
    ...
    "    <div style=\"position:absolute; top:0; left:0; right:0; bottom:0; display:flex; flex-direction:column; background-color:#232F3E; padding:40px 64px;\">\n"
    "      <div class=\"tech-grid\"></div>\n"
    "      <div style=\"z-index:10;\">\n"
    "        <div class=\"accent-bar\"></div>\n"
    "        <h2 style=\"color:#fff; font-size:2.25rem; font-weight:800; margin-bottom:8px;\">제목</h2>\n"
    "        <p class=\"accent-eyebrow\">SECTION LABEL</p>\n"
    "      </div>\n"
    "      <div style=\"flex:1; display:flex; align-items:flex-start; gap:32px; z-index:10;\">\n"
    "        <!-- 좌우 분할 콘텐츠 -->\n"
    "      </div>\n"
    "    </div>\n"
    "  </section>\n\n"
    ...
    "- 타이포그래피 규칙:\n"
    "  · 슬라이드 제목(h1): font-size:2.25rem(36px) 이상, font-weight:800\n"
    "  · 섹션 제목(h2): font-size:2rem(32px), font-weight:700\n"
    "  · 카드 제목(h3): font-size:1.25rem(20px), font-weight:700\n"
    "  · 본문/설명: font-size:1rem~1.25rem(16~20px), font-weight:400, line-height:1.5~1.6\n"
    "  · 태그/라벨: .accent-eyebrow 또는 .tag 클래스 사용\n"
    "  · 12px 이하의 작은 글꼴은 절대 사용하지 마세요.\n\n"
    "출력 규칙:\n"
...
SLIDES_REGION_SYSTEM_PROMPT = (
    ...
    "- agenda: <ul class=\"agenda-list\"><li style=\"padding:6px 0; font-size:1.1rem;\">안건 1</li></ul> (6개 이상이면 font-size:1rem, padding:5px 0)\n"
    ...
    "</div></div>\n\n"
    "영역별 콘텐츠 가이드:\n"
    "- title 영역: 제목 텍스트. font-size:2.25rem(36px) 이상, font-weight:800. .accent-bar 또는 .divider-bar 등 장식 요소 포함 가능.\n"
    "- subtitle 영역: 부제목/설명 텍스트. font-size:1.25rem(20px) 이상, font-weight:400. .accent-eyebrow 클래스로 라벨 표현 가능.\n"
    ...
    "- 카드 제목(h3): font-size:1.25rem(20px), font-weight:700\n"
    "- 본문/설명: font-size:1rem~1.25rem(16~20px), font-weight:400, line-height:1.5~1.6\n"
    "- 태그/라벨(.tag): font-family:monospace, font-size:0.875rem(14px)\n"
    ...
    "- 높이 계산 가이드 (231px 기준):\n"
    "  · agenda-list li(padding:6px 0, font:1.1rem → 약 28px/항목): 최대 7개=196px. 항목이 6개 이상이면 font-size:1rem, padding:5px 0으로 줄이세요.\n"
