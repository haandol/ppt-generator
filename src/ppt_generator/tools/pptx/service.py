...
from ppt_generator.interfaces.schemas import PptxRequest, PptxResponse
from ppt_generator.templates.layout_mapping import get_layout_info
...
class PptxService:
    ...
    def generate(self, request: PptxRequest) -> PptxResponse:
        ...
        for i, slide_outline in enumerate(request.slides):
            ...
            self._set_image(slide, i, request.image_paths, layout_info.picture_ph, slide_outline.image_idea)
